...
class RecipeIngredientsTest < ApplicationSystemTestCase
  ...
  test "creating a Recipe ingredient" do
    ...
    fill_in "Measurement", with: @recipe_ingredient.measurement_id
    fill_in "Recipe", with: @recipe_ingredient.recipe_id
    check "Substitute possible" if @recipe_ingredient.substitute_possible
    check "Vital" if @recipe_ingredient.vital
